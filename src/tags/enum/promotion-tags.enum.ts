export enum PromotionTagsEnum {
  DROP_BY_NOW = 'DROP_BY_NOW', // short distance sale
  SAVE_EVERY_DAY = 'SAVE_EVERY_DAY', // long distance sale
  PWP = 'PWP', // vary distances sale + product restriction
